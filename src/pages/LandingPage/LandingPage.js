  ...
  return (
    <div className="w-screen h-screen flex flex-col items-start justify-between">
      ...
      <div>
        ...
        <button className="rounded font-bold text-16 text-light-bright bg-primary-default shadow-xl hover:bg-primary-dark mx-48 md:mx-80 my-16 p-16">
          Get Started
        </button>
      </div>
      <img
